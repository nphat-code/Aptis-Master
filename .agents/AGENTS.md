...
18. **Writing Scoring & CEFR Standard**:
    - Single Part practice tests for Writing Part 1, Part 2, Part 3, and Part 4 strictly use max 10 points scale (`maxScore = 10` points per part: 9-10/10 Excellent, 7-8/10 Good, 5-6/10 Pass, 3-4/10 Satisfactory, 0-2/10 Needs Work / Blank).
